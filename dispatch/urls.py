...
urlpatterns = [
    ...
    path('computer_dispatch/list', views.computer_dispatch_list_view, name='computer_dispatch_list'),
    path('computer_dispatch/<int:id>/print', views.computer_dispatch_print_view, name='computer_dispatch_print'),
]